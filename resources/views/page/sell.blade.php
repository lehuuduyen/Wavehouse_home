                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text">
                            <input type="hidden" name="csrfmiddlewaretoken"
                                ...
                                <select class="form-select sweezy-custom-cursor-default-hover" name="bank" id="exampleSelect1" onchange="if (!window.__cfRLUnblockHandlers) return false; getnamebank(this.value)">
