...
<div kendo-window="myKendoWindow" k-options="options" modal-render="true" role="dialog" uib-modal-window="modal-window" index="0" animate="animate" class="ng-isolate-scope k-window-content k-content" data-role="window" tabindex="-1" style="">
    <div class="k-window-titlebar k-header" style="margin-top: -62px;">&nbsp;<span class="k-window-title">Thêm hàng</span></div>

    <div uib-modal-transclude=""><kv-add-new-product from-order-supplier="false" from-purchase-order="false" form-name="productForm" product-listeners="listeners" product-popup="popup" product-on-save="onSave(resp)" product-on-cancel="onCancel()" product-on-delete="onDelete(resp)" class="ng-scope ng-isolate-scope">
            <form name="productForm" id="product-add" class="ng-pristine ng-valid ng-valid-maxlength ng-valid-parse"><!-- ngIf: !isActiveGppDrugStore || product.ProductType ==3 || product.ProductType == 1 -->
                <section class="boxInfo addProduct uln fr  addProductNotDrug" ng-if="!isActiveGppDrugStore || product.ProductType ==3 || product.ProductType == 1"><kv-tabs id="pro_tabs" ng-model="proTabs" class="ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty">
                        <div class="kvTabs clearfix ulN">
                            <ul class="mr-bg"><!-- ngRepeat: pane in panes -->
                                <li ng-repeat="pane in panes" class="ng-scope"><a skip-disable="" tabindex="-1" kv-focus-item="tabBut_0" ng-click="select(pane, false, $index)" class="tabBut_0  tabbut_new active" ng-class="{'active':pane.selected}">Thông tin</a></li><!-- end ngRepeat: pane in panes -->
                                <li ng-repeat="pane in panes" class="ng-scope"><a skip-disable="" tabindex="-1" kv-focus-item="tabBut_1" ng-click="select(pane, false, $index)" class="tabBut_1  tabbut_new" ng-class="{'active':pane.selected}">Mô tả chi tiết</a></li><!-- end ngRepeat: pane in panes -->
                                <li ng-repeat="pane in panes" class="ng-scope"><a skip-disable="" tabindex="-1" kv-focus-item="tabBut_2" ng-click="select(pane, false, $index)" class="tabBut_2  tabbut_new" ng-class="{'active':pane.selected}">Thành phần</a></li><!-- end ngRepeat: pane in panes -->
                                <li ng-repeat="pane in panes" class="ng-scope"><a skip-disable="" tabindex="-1" kv-focus-item="tabBut_3" ng-click="select(pane, false, $index)" class="tabBut_3  tabbut_new" ng-class="{'active':pane.selected}">Bảo hành, bảo trì</a></li><!-- end ngRepeat: pane in panes -->
                            </ul>
                            <div class="tabBg"></div>
                            <div ng-transclude=""><kv-tab-pane kvtitle="_l.baseProductInfo" kv-tab-id="1" class="ng-scope ng-isolate-scope">
                                    <div ng-show="selected" ng-transclude="">
                                            ...
                                            <div class="row pro_baseForm">
                                                <div class="col-md-6 addPro-left">
                                                            ...
                                                            <autocomplete id="idSuggestProductCodeSearch" attr-class="suggest-product-search" attr-inputid="idSuggestProductCodeSearchTerm" attr-inputclass="iptCode tabBut_0 form-control" attr-placeholder="Mã hàng tự động" attr-maxlength="40" attr-validspecialchar="Mã hàng" ng-model="product.Code" template-id="suggestProductTemp" data="suggestProductList" on-type="suggestProductSearchTermChanged" input-blur="updateListProducts('Code'); updateCodeProductsUnits(); validateAddProduct(typeValidateCode);" on-select="selectSuggestProductByCode" is-disable-enter-bar-scanner="true" do-not-get-first-by-enter="true" is-not-show-not-found="true" external-query-search="product_code" class="ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty">
                                                                <div class="autocomplete suggest-product-search" id=""><input type="text" ng-blur="inputBlur()" autocomplete="off" ng-model="searchParam" maxlength="40" placeholder="Mã hàng tự động" class="iptCode tabBut_0 form-control iptUnitName_  ng-empty ng-valid-maxlength ng-touched" id="idSuggestProductCodeSearchTerm" tabindex="" ng-disabled="kvDisable" kv-valid-special-chars="Mã hàng">
                                                                    <div ng-show="completing" class="output-complete ng-hide" ng-mousedown="autocompleFocus($event)">
                                                                        <ul ng-hide="suggestions &amp;&amp; suggestions.length == 0 &amp;&amp; isNotShowNotFound"><!-- ngRepeat: suggestion in suggestions track by $index --></ul>
                                                    ...
                                                    <div class="form-group"><label class="form-label control-label ng-binding">Nhóm hàng<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Lựa chọn nhóm hàng cho sản phẩm"><i class="fas fa-info-circle"></i></a></label>
                                                        <div class="form-wrap"><kv-category-dropdownlist selected-id="product.CategoryId" css-class="product-select" class="input-group ng-isolate-scope" include-add="true" on-add="EditCategory"><span title="" class="k-widget k-dropdown k-header form-control product-select" unselectable="on" role="listbox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-readonly="false" style="width: 100%;" aria-busy="false" aria-activedescendant="048588fe-2cfc-49f1-9251-0c442efabfdd"><span unselectable="on" class="k-dropdown-wrap k-state-default"><span unselectable="on" class="k-input ng-scope"> ---Lựa chọn---</span><span unselectable="on" class="k-select"><span unselectable="on" class="k-icon k-i-arrow-s">select</span></span></span><select kendo-drop-down-list="" id="ddlCat2367" class="product-select form-control" k-options="categorySelectOptions" k-ng-model="selectedId" k-filter="'contains'" k-value-primitive="true" data-option-label="{Name: _l.globalSelect1,Id:null}" style="width: 100%; display: none;" data-role="dropdownlist">
                                                                        <option value="null" selected="selected"> ---Lựa chọn---</option>
                                                                        <option value="558704">tai nghe</option>
                                                                    </select></span>
                                                                <div class="input-group-append ng-scope"><!-- ngIf: includeAdd --><a ng-if="includeAdd" ng-click="onAdd &amp;&amp; onAdd()" ng-enter="onAdd &amp;&amp; onAdd()" class="btn-icon ng-scope" title="Thêm nhóm hàng" tabindex="0"><i class="far fa-plus"></i></a><!-- end ngIf: includeAdd --></div>
                                                            </kv-category-dropdownlist></div>
                                                    </div>
                                                    <div class="form-group" ng-hide="isActiveGppDrugStore"><label class="form-label control-label ng-binding">Thương hiệu<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Thương hiệu, nhãn hiệu của sản phẩm"><i class="fas fa-info-circle"></i></a></label>
                                                        <div class="form-wrap" ng-class="product.TradeMarkId > 0 ? 'wrap-icon-edit': ''"><kv-trademark-drop-down-list trademark="TradeMark" class="input-group ng-isolate-scope" on-trademark-change="changeTrademark(trademarkId)"><span title="" class="k-widget k-dropdown k-header form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-parse" unselectable="on" role="listbox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-owns="ddlTradeMark_listbox" aria-disabled="false" aria-readonly="false" aria-busy="false" style="" aria-activedescendant="2fa10269-d141-4587-95a6-6ab553cadb04"><span unselectable="on" class="k-dropdown-wrap k-state-default"><span unselectable="on" class="k-input ng-scope">---Chọn thương hiệu---</span><span unselectable="on" class="k-select"><span unselectable="on" class="k-icon k-i-arrow-s">select</span></span></span><select kendo-drop-down-list="" id="ddlTradeMark" k-data-source="tradeMarkList" k-option-label="'---Chọn thương hiệu---'" k-data-text-field="'Name'" k-data-value-field="'Id'" ng-model="tradeMarkSelectedId" k-value-primitive="true" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-parse" k-filter="'contains'" k-on-change="changeTradeMark()" height="266" data-role="dropdownlist" style="display: none;">
                                                                        <option value="" selected="selected">---Chọn thương hiệu---</option>
                                                                    </select></span>
                                                                <div class="input-group-append"><!-- ngIf: tradeMarkSelectedId > 0 --> <a class="btn-icon" ng-click="openAddOrEditTrademark(false)" ng-enter="openAddOrEditTrademark(false)" tabindex="0"><i class="far fa-plus"></i></a></div>
                                                            </kv-trademark-drop-down-list></div>
                                                    </div>
                                                    <div class="form-group" ng-show="product.ProductType!=pTypeValue.Service"><label class="form-label control-label ng-binding">Vị trí<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Sử dụng để ghi lại vị trí mà hàng hóa được cất giữ hoặc trưng bày. Ví dụ: kệ số 1, số 2..."><i class="fas fa-info-circle"></i></a></label>
                                                        <div class="form-wrap"><kv-shelves-drop-down-list class="input-group ng-isolate-scope" product-shelves-list="product.ProductShelves" on-shelves-list-change="changeShelvesList(shelvesIds)">
                                                                ...
                                                                <div class="input-group-append"><!-- ngIf: (shelvestList && shelvestList.length > 0) --> <a class="btn-icon" ng-click="openAddOrEditShelves(false)" ng-enter="openAddOrEditShelves(false)" tabindex="0"><i class="far fa-plus"></i></a></div>
                                                            </kv-shelves-drop-down-list></div>
                                                    </div><!-- ngIf: appSetting.TimeSheet && !timeSheetPosParameter.isExpired && _p.has('Commission_Update') -->
                                                        ...
                                                        <article class="product-upload product-upload-new posR ng-scope" ng-controller="ProductImageUploadCtrl">
                                                            <ul class="">
                                                                <li class="li-odd ProductImageUpload">
                                                                    <div>
                                                                        <article class="proListImg uln posR"><kv-swiper kv-page-load="loadPage" kv-count-page="updateTotalPage" template-id="productListTmpl" kv-height="80" item-per-page="pageSize" swiper-name="productSwiper" kv-item-selected="imageActionHandler" class="ng-isolate-scope">
                                                                                <div class="swiper-container swiperList">
                                                                                    <div class="swiper-wrapper" style="height: 10px; width: 0px;"><!-- ngRepeat: slide in slides track by slide.Id --></div>
                                                                                </div>
                                                                            </kv-swiper></article>
                                                                    </div>
                                                                    <div class="img-pr"><label class="img-pr-left custom-upload"><input class="chooseImageFocus ng-pristine ng-untouched ng-valid ng-isolate-scope ng-not-empty" style="display: none;" name="files" id="new-files" type="file" placeholder="Chọn ảnh" kv-file-upload="" ng-model="kvProductAddCtrl.productImages" kv-options="uploadImages" multiple=""> <span class="kv2Btn ng-binding" style="display: none;">Chọn ảnh</span> <span class="upload-error overSizeFile ng-binding" style="display: none" ng-bind-html="UploadError"></span></label></div>
                                                                </li>
                                                            </ul>
                                                            <ul class="uploadImageButton"><!-- ngRepeat: i in [].constructor(5) track by $index -->
                                                                <li class="show ng-scope"><label for="new-files" ng-keyup="openFileDialog($event)" tabindex="0"><span class="kv2Btn ng-binding">+ Thêm</span> <img src="https://cdn-app.kiotviet.vn/retailler/Content/img/default-product-img.jpg" alt=""></label></li><!-- end ngRepeat: i in [].constructor(5) track by $index -->
                                                                <li class="show ng-scope"><label for="new-files" ng-keyup="openFileDialog($event)"><span class="kv2Btn ng-binding">+ Thêm</span> <img src="https://cdn-app.kiotviet.vn/retailler/Content/img/default-product-img.jpg" alt=""></label></li><!-- end ngRepeat: i in [].constructor(5) track by $index -->
                                                                <li class="show ng-scope"><label for="new-files" ng-keyup="openFileDialog($event)"><span class="kv2Btn ng-binding">+ Thêm</span> <img src="https://cdn-app.kiotviet.vn/retailler/Content/img/default-product-img.jpg" alt=""></label></li><!-- end ngRepeat: i in [].constructor(5) track by $index -->
                                                                <li class="show ng-scope"><label for="new-files" ng-keyup="openFileDialog($event)"><span class="kv2Btn ng-binding">+ Thêm</span> <img src="https://cdn-app.kiotviet.vn/retailler/Content/img/default-product-img.jpg" alt=""></label></li><!-- end ngRepeat: i in [].constructor(5) track by $index -->
                                                                <li class="show ng-scope"><label for="new-files" ng-keyup="openFileDialog($event)"><span class="kv2Btn ng-binding">+ Thêm</span> <img src="https://cdn-app.kiotviet.vn/retailler/Content/img/default-product-img.jpg" alt=""></label></li><!-- end ngRepeat: i in [].constructor(5) track by $index -->
                                                            </ul>
                                                ...
                                                <div class="col-md-6 addPro-right">
                                                    ...
                                                    <div class="form-group isShowAdd"><label class="form-label control-label ng-binding">Giá bán</label>
                                                        <div class="form-wrap input-group"><input id="iptBasePriceMaster" type="text" class="form-control text-right iptPriceSale ng-pristine ng-untouched ng-valid ng-not-empty" ng-model="product.BasePrice" ng-blur="updateListProducts('BasePrice'); calPoint('BasePrice', product)" title="Bảng giá chung" kv-auto-numeric="{isProductPrice: true}" k-min="0">
                                                            <div class="input-group-append"><a ng-click="addPricebook()" ng-enter="addPricebook()" class="btn-icon" tabindex="0"><i class="fa fa-tags"></i></a></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" ng-show="(!fromPurchaseOrder &amp;&amp; !fromOrderSupplier &amp;&amp; (!fromPurchaseOrder &amp;&amp; !fromOrderSupplier)) &amp;&amp; product.ProductType==pTypeValue.Purchased &amp;&amp; !product.IsLotSerialControl &amp;&amp; !product.IsBatchExpireControl"><label class="form-label control-label ng-binding">Tồn kho<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Số lượng tồn kho của sản phẩm (sẽ tự động tạo ra phiếu kiểm kho cho sản phẩm)"><i class="fas fa-info-circle"></i></a></label>
                                                    ...
                                                    <div class="form-group form-cal-size-wrap" ng-show="(appSetting.UseCod || isShowConstructionMaterial) &amp;&amp; product.ProductType!=pTypeValue.Service"><label class="form-label control-label ng-binding">Trọng lượng<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Sử dụng để tính trọng lượng khi giao hàng"><i class="fas fa-info-circle"></i></a></label>
                                                        <div class="form-wrap"><!-- ngIf: !isShowConstructionMaterial --><input ng-if="!isShowConstructionMaterial" type="text" class="form-control text-right ng-pristine ng-untouched ng-valid ng-scope ng-empty" ng-model="product.Weight" ng-blur="updateListProducts('Weight')" kv-auto-numeric="{mDec:3}" k-min="0"><!-- end ngIf: !isShowConstructionMaterial --><!-- ngIf: isShowConstructionMaterial --></div>
                                                    </div>
                                                    <div class="form-group ng-hide" ng-show="product.IsRewardPoint &amp;&amp; appSetting.RewardPoint_Type == _rewardPointType.Product"><label class="form-label control-label ng-binding">Điểm thưởng</label>
                                                    ...
                                                    </div><!-- ngIf: isShowConstructionMaterial && pTypeValue && productType == pTypeValue.Purchased --><!-- ngIf: isShowConstructionMaterial && isShowSuggestMatAttr && suggestMaterialAttribute && suggestMaterialAttribute.length > 0 -->
                                                    <div class="selectProductType"><!-- ngIf: !(product.ProductUnits && product.ProductUnits.length > 0) || product.IsLotSerialControl || !appSetting.UseMultiUnit -->
                                                        <aside class="pro_chk proSale mb10 ng-scope has-pretty-child" ng-if="!(product.ProductUnits &amp;&amp; product.ProductUnits.length > 0) || product.IsLotSerialControl || !appSetting.UseMultiUnit">
                                                            <div class="clearfix prettycheckbox labelright  blue"><input tabindex="0" type="checkbox" ng-checked="product.AllowsSale" ng-change="updateListProducts('AllowsSale')" kv-pretty-check="" kv-data-label="_l.productAllowsSale" ng-model="product.AllowsSale" class="ng-pristine ng-untouched ng-valid ng-isolate-scope ng-not-empty" data-label="Bán trực tiếp" style="display: none;" checked="checked"><a href="javascript:void(0)" tabindex="0" class="checked"></a>
                                                                <label for="undefined" class="checked">Bán trực tiếp</label>
                                                        ...
                                                        </aside><!-- end ngIf: !(product.ProductUnits && product.ProductUnits.length > 0) || product.IsLotSerialControl || !appSetting.UseMultiUnit -->
                                                        <aside class="mb10 pro_chk proSerial has-pretty-child" ng-show="product.ProductType==pTypeValue.Purchased &amp;&amp; appSetting.UseImei &amp;&amp; !isCafe">
                                                            <div class="clearfix prettycheckbox labelright  blue"><input tabindex="0" type="checkbox" kv-pretty-check="" kv-data-label="'Serial/Imei'" class="ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty" style="display: none;"><a href="javascript:void(0)" tabindex="0" class=""></a>
                                                        ...
                                                        <aside class="mb10 pro_chk proSerial has-pretty-child ng-hide" ng-show="product.ProductType==pTypeValue.Purchased &amp;&amp; appSetting.UseBatchExpire &amp;&amp; !isCafe">
                                                            <div class="clearfix prettycheckbox labelright  blue"><input tabindex="0" type="checkbox" kv-pretty-check="" kv-data-label="'Lô, hạn sử dụng'" class="ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty" style="display: none;"><a href="javascript:void(0)" tabindex="0" class=""></a>
                                                                <label for="undefined" class="">Lô, hạn sử dụng</label>
                                        ...
                                        <article class="proBox product-formPrice ng-scope mb15" ng-show="appSetting.UseVariants" title="" ng-class="product.ProductType==pTypeValue.Purchased&amp;&amp;appSetting.UseMultiUnit?'mb15':''">
                                            <h3 class="cursor " ng-click="activeVariant()" ng-enter="activeVariant()"><a href="" tabindex="0" class="ng-binding">Thuộc tính<i class="fa flr fs14 fa-chevron-down"></i></a></h3><!-- ngIf: showInputVariant -->
                                        </article>
                                            ...
                                            <article class="showUnit proBoxItems ng-hide" ng-show="showProductUnit">
                                                <div class="form-wrapper form-labels-block mb5">
                                                    <div class="form-inline">
                                                        <div class="form-group"><label class="form-label control-label ng-binding">Đơn vị cơ bản<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Đơn vị của hàng hóa như: hộp, lốc, thùng…"><i class="fas fa-info-circle"></i></a></label>
                                                            <div class="form-wrap"><unit-product-suggestion-input-form all-product-units="product.ProductUnits" unit="product" unit-index="$index" on-select-unit-suggestion="onSelectUnitSuggestion(unit, unitIndex)" is-base-unit="true" on-callback-blur="checkUnitName(item, oldConversionUnit, $index, isBaseUnit)" class="ng-isolate-scope">
                                                                ...
                                                                </unit-product-suggestion-input-form></div>
                                                        </div><!-- ngIf: !product.IsLotSerialControl && product.ProductUnits && product.ProductUnits.length > 0 -->
                                                    </div>
                                                </div>
                                                <div class="tblProduct-wrap"><!-- ngIf: !product.IsLotSerialControl && appSetting.UseMultiUnit && product.ProductType == pTypeValue.Purchased -->
                                                    <table class="tblProduct mb10 ng-scope ng-hide" ng-if="!product.IsLotSerialControl &amp;&amp; appSetting.UseMultiUnit &amp;&amp; product.ProductType == pTypeValue.Purchased" ng-show="product.ProductUnits.length >0">
                                                        <tbody>
                                                            <tr ng-show="product.ProductUnits.length >0" class="ng-hide">
                                                                <th class="cell-name"><span class="titleFr ng-binding">Tên đơn vị</span></th>
                                                                <th class="cell-unit"><span class="titleFr ng-binding">Giá trị quy đổi</span></th>
                                                                <th class=""><span class="titleFr ng-binding">Giá bán</span></th>
                                                                <th class="cell-code" ng-hide="isShowAttrList"><span class="titleFr ng-binding">Mã hàng</span></th>
                                                                <th class="cell-code" ng-show="appSetting.UseBarcode &amp;&amp; !isShowAttrList"><span class="titleFr ng-binding">Mã vạch</span></th>
                                                                <th class="cell-quantity ng-hide" ng-show="appSetting.RewardPoint_Type == _rewardPointType.Product &amp;&amp; product.IsRewardPoint &amp;&amp; !isShowAttrList"><span class="titleFr ng-binding">Điểm</span></th>
                                                                <th><span class="titleFr"></span></th>
                                                                <th></th>
                                                            </tr><!-- ngRepeat: item in product.ProductUnits -->
                                                        </tbody>
                                                    </table><!-- end ngIf: !product.IsLotSerialControl && appSetting.UseMultiUnit && product.ProductType == pTypeValue.Purchased -->
                                                </div><!-- ngIf: !product.IsLotSerialControl && appSetting.UseMultiUnit && product.ProductType == pTypeValue.Purchased -->
                                                <aside class="ovh mb15 ng-scope" ng-if="!product.IsLotSerialControl &amp;&amp; appSetting.UseMultiUnit &amp;&amp; product.ProductType == pTypeValue.Purchased"><button type="button" ng-click="addMoreUnit()" ng-enter="addMoreUnit()" class="btn btn-white ng-binding" kv-focus-item="iptUnitName_-1"><i class="far fa-plus"></i>Thêm đơn vị</button></aside><!-- end ngIf: !product.IsLotSerialControl && appSetting.UseMultiUnit && product.ProductType == pTypeValue.Purchased -->
                                            </article>
                                        </article>
                                        <article class="proBox pro-unitList ng-scope ng-hide" ng-show="isShowAttrList">
                                            <h3 class="ng-binding">Danh sách hàng hóa cùng loại</h3><kv-attribute-list-table show-cost-price="showCostPrice" from-purchase-order="fromPurchaseOrder" list-products="listProducts" product-type="productType" on-edit-auto-code="onEditAutoGenCode" remove-attr-value="removeTagAttrWhenChangeListProduct()" edit-on-hand="rights.editOnHand" remove-units="removeUnitWhenChangeListProduct()" list-deleted-products="listDeletedProducts" class="ng-isolate-scope">
                                                <div class="srcUnit proBoxItems">
                                                    <table class="tblUnit">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" class="ng-binding">Tên</th>
                                                                <th scope="col" ng-show="listProducts[0].Unit" class="cell-unitUnit ng-binding ng-hide">Đơn vị</th>
                                                                <th scope="col" class="cell-code ng-binding">Mã hàng</th>
                                                                ...
                                                                <th scope="col" ng-show="$parent.product.IsRewardPoint &amp;&amp; $parent.appSetting.RewardPoint_Type == $parent._rewardPointType.Product" class="tdPointInput ng-binding ng-hide">Điểm</th>
                                                                <th class="unitDel"></th>
                                                            </tr>
                                                        </thead><!-- ngRepeat: item in listProducts track by $index -->
                                                    </table>
                                                </div>
                                                <div class="txtR txtI proBoxItems ng-binding">Danh sách bao gồm hàng hóa cùng loại</div>
                                                <div>&nbsp;</div>
                                    ...
                                    <div ng-show="selected" ng-transclude="" class="ng-hide">
                                        <div ng-show="product.ProductType==pTypeValue.Purchased" class="panel panel-default ng-scope">
                                            ...
                                            <div class="panel-body">
                                                <div class="row form-wrapper">
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label class="form-label control-label ng-binding">Ít nhất<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Hệ thống sẽ dựa vào thông tin này để cảnh báo hàng dưới định mức tồn nếu tồn kho < Tồn ít nhất"><i class="fas fa-info-circle"></i></a></label>
                                                            <div class="form-wrap"><input type="text" ng-model="product.MinQuantity" ng-blur="updateListProducts('MinQuantity')" kv-auto-numeric="{mDec:3}" k-min="0" class="tabBut_1 form-control text-right ng-pristine ng-untouched ng-valid ng-not-empty"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label class="form-label control-label ng-binding">Nhiều nhất<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Hệ thống sẽ dựa vào thông tin này để cảnh báo hàng vượt định mức tồn nếu tồn kho > Tồn nhiều nhất"><i class="fas fa-info-circle"></i></a></label>
                                                            <div class="form-wrap"><input type="text" ng-model="product.MaxQuantity" ng-blur="updateListProducts('MaxQuantity')" kv-auto-numeric="{mDec:3}" k-min="0" class="form-control text-right ng-pristine ng-untouched ng-valid ng-not-empty"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <td class="k-editor-toolbar-wrap" role="presentation">
                                                                <ul class="k-editor-toolbar ng-scope" role="toolbar" data-role="editortoolbar">
                                                                    <li class="k-tool-group" role="presentation" tabindex="-1"><span class="k-editor-dropdown k-group-start k-group-end" tabindex="-1"><span title="Format" class="k-widget k-dropdown k-header k-editor-widget" unselectable="on" role="listbox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-owns="" aria-disabled="false" aria-readonly="false" aria-busy="false" style="width: 110px;" aria-activedescendant="57d68efe-beae-4ea0-b03c-2631299b2f94"><span unselectable="on" class="k-dropdown-wrap k-state-default" tabindex="-1"><span unselectable="on" class="k-input" tabindex="-1">Format</span><span unselectable="on" class="k-select" tabindex="-1"><span unselectable="on" class="k-icon k-i-arrow-s" tabindex="-1">select</span></span></span><select title="Format" class="k-formatting k-decorated" data-role="selectbox" unselectable="on" style="width: 110px; display: none;" tabindex="-1">
                                                                                    <option value="p" tabindex="-1">Paragraph</option>
                                                                                    <option value="blockquote" tabindex="-1">Quotation</option>
                                                                                    <option value="h1" tabindex="-1">Heading 1</option>
                                                                                    <option value="h2" tabindex="-1">Heading 2</option>
                                                                                    <option value="h3" tabindex="-1">Heading 3</option>
                                                                                    <option value="h4" tabindex="-1">Heading 4</option>
                                                                                    <option value="h5" tabindex="-1">Heading 5</option>
                                                                                    <option value="h6" tabindex="-1">Heading 6</option>
                                                                                </select></span></span></li>
                                                                    <li class="k-tool-group k-button-group" role="presentation" tabindex="-1"><a href="" role="button" class="k-tool k-group-start" unselectable="on" title="Bold" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-bold" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Bold</span></a><a href="" role="button" class="k-tool" unselectable="on" title="Italic" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-italic" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Italic</span></a><a href="" role="button" class="k-tool k-group-end" unselectable="on" title="Underline" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-underline" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Underline</span></a></li>
                                                                    <li class="k-tool-group k-button-group" role="presentation" tabindex="-1"><a href="" role="button" class="k-tool k-group-start" unselectable="on" title="Align text left" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-justifyLeft" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Align text left</span></a><a href="" role="button" class="k-tool" unselectable="on" title="Center text" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-justifyCenter" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Center text</span></a><a href="" role="button" class="k-tool k-group-end" unselectable="on" title="Align text right" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-justifyRight" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Align text right</span></a></li>
                                                                    <li class="k-tool-group k-button-group" role="presentation" tabindex="-1"><a href="" role="button" class="k-tool k-group-start" unselectable="on" title="Insert unordered list" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-insertUnorderedList" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Insert unordered list</span></a><a href="" role="button" class="k-tool" unselectable="on" title="Insert ordered list" aria-pressed="false" tabindex="-1"><span unselectable="on" class="k-tool-icon k-insertOrderedList" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Insert ordered list</span></a><a href="" role="button" class="k-tool k-group-end" unselectable="on" title="Indent" tabindex="-1"><span unselectable="on" class="k-tool-icon k-indent" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Indent</span></a><a href="" role="button" class="k-tool k-group-end k-state-disabled" unselectable="on" title="Outdent" tabindex="-1"><span unselectable="on" class="k-tool-icon k-outdent" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Outdent</span></a></li>
                                                                    <li class="k-tool-group k-button-group" role="presentation" tabindex="-1"><a href="" role="button" class="k-tool k-group-start" unselectable="on" title="Insert hyperlink" tabindex="-1"><span unselectable="on" class="k-tool-icon k-createLink" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Insert hyperlink</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Remove hyperlink" tabindex="-1"><span unselectable="on" class="k-tool-icon k-unlink" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Remove hyperlink</span></a><a href="" role="button" class="k-tool k-group-end" unselectable="on" title="Insert image" tabindex="-1"><span unselectable="on" class="k-tool-icon k-insertImage" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Insert image</span></a></li>
                                                                    <li class="k-tool-group k-button-group" role="presentation" tabindex="-1" style="display: none;"><a href="" role="button" class="k-tool k-group-start k-group-end" data-popup="" unselectable="on" title="Create table" tabindex="-1"><span unselectable="on" class="k-tool-icon k-createTable" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Create table</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Add column on the left" tabindex="-1"><span unselectable="on" class="k-tool-icon k-addColumnLeft" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Add column on the left</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Add column on the right" tabindex="-1"><span unselectable="on" class="k-tool-icon k-addColumnRight" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Add column on the right</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Add row above" tabindex="-1"><span unselectable="on" class="k-tool-icon k-addRowAbove" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Add row above</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Add row below" tabindex="-1"><span unselectable="on" class="k-tool-icon k-addRowBelow" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Add row below</span></a><a href="" role="button" class="k-tool k-state-disabled" unselectable="on" title="Delete row" tabindex="-1"><span unselectable="on" class="k-tool-icon k-deleteRow" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Delete row</span></a><a href="" role="button" class="k-tool k-group-end k-state-disabled" unselectable="on" title="Delete column" tabindex="-1"><span unselectable="on" class="k-tool-icon k-deleteColumn" tabindex="-1"></span><span class="k-tool-text" tabindex="-1">Delete column</span></a></li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="k-editable-area"><iframe title="Editable area. Press F10 for toolbar." frameborder="0" class="k-content" tabindex="0" src="javascript:&quot;&quot;"></iframe><textarea placeholder="Ghi chú" k-encoded="true" kendo-editor="" k-ng-model="product.Description" k-options="descriptionOptions" maxlength="30000" data-role="editor" autocomplete="off" class="k-content k-raw-content" style="display: none;"></textarea></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="panel panel-default proBox ng-scope">
                                            <h5 class="panel-heading ng-binding">Mẫu ghi chú (hóa đơn, đặt hàng)</h5>
                                            <div class="proBoxItems"><textarea ng-model="product.OrderTemplate" ng-blur="updateListProducts('OrderTemplate')" class="form-control form-control-noborder ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength" rows="5" maxlength="300"></textarea></div>
                                        </div>
                                    </div>
                                    ...
                                    <div ng-show="selected" ng-transclude="" class="ng-hide">
                                        <div class="form-wrapper form-labels-190 ng-scope">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group"><label class="form-label control-label ng-binding">Hàng hóa thành phần<a tabindex="-1" class="help icon" kv-tooltip="" data-toggle="tooltip" data-placement="right" data-original-title="Hàng hóa được tạo thành từ nhiều hàng hóa hoặc dịch vụ khác"><i class="fas fa-info-circle"></i></a></label>
                                                        <div class="form-wrap">
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr ng-show="rights.viewCost" class="trTotal">
                                                            <td colspan="6" class="txtB txtR ng-binding">Tổng giá vốn thành phần:</td>
                                                            <td class="txtR ng-binding">0</td>
                                                        </tr>
                                                        <tr class="trTotal">
                                                            <td colspan="6" class="txtB txtR ng-binding">Tổng giá bán thành phần:</td>
                                                            <td class="txtR ng-binding">0</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="form-group" ng-show="product.ProductFormulas==null||product.ProductFormulas.length ==0">
                                                <div class="form-wrap">
                                                    <div class="txtGray txtI ng-binding">Hàng hóa này chưa có định lượng nguyên liệu.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <aside class="form-group">
                                                                <div class="window-wrap-table">
                                                                    <table class="guarantee-table">
                                                                        <tbody>
                                                                            <tr>
                                                                                <th class="tdDetail ng-binding">Bảo hành</th>
                                                                                <th class="tdExpire"><span class="titleFr ng-binding">Thời hạn bảo hành</span></th>
                                                                            </tr>
                                                                            <tr ng-hide="product.GenuineGuarantees &amp;&amp; product.GenuineGuarantees.length > 0">
                                                                                <td colspan="2" class="guarantee-td--custom ng-binding">Chưa có bảo hành nào</td>
                                                                            </tr><!-- ngRepeat: item in product.GenuineGuarantees -->
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            </aside>
                                                            <aside class=""><button type="button" ng-click="addMoreGenuineGuarantees()" class="btn btn-small btn-white focusAMA ng-binding" kv-focus-item="genuine_guarantee_-1" kv-focus-kendo-widget="kendoDropDownList"><i class="far fa-plus"></i>Thêm mốc</button></aside>
                                                        </div>
                                                    </article>
                                                            ...
                                                            <aside class="form-group">
                                                                <div class="window-wrap-table">
                                                                    <table class="guarantee-table">
                                                                        <tbody>
                                                                            <tr>
                                                                                <th class="tdDetail ng-binding">Bảo trì định kỳ</th>
                                                                                <th class="tdExpire"><span class="titleFr ng-binding">Thời hạn bảo trì</span></th>
                                                                            </tr>
                                                                            <tr ng-hide="product.showMaintenance">
                                                                                <td colspan="2" class="guarantee-td--custom ng-binding">Chưa có bảo trì nào</td>
                                                                            </tr><!-- ngIf: product.showMaintenance -->
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            </aside><!-- ngIf: !product.showMaintenance -->
                                                            <aside class="ng-scope" ng-if="!product.showMaintenance"><button type="button" ng-click="product.showMaintenance = true" class="btn btn-small btn-white focusAMA ng-binding" kv-focus-item="periodic_guarantee" kv-focus-kendo-widget="kendoDropDownList"><i class="far fa-plus"></i>Thêm mốc</button></aside><!-- end ngIf: !product.showMaintenance -->
                                                        </div>
                                                    </article>
                                                </div>
                                            </div>
                    ...
                    </kv-tabs></section><!-- end ngIf: !isActiveGppDrugStore || product.ProductType ==3 || product.ProductType == 1 --><!-- ngIf: isActiveGppDrugStore && product.ProductType !=3 && product.ProductType != 1 -->
