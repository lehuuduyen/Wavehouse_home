...
class HomeController extends BaseController
{
     ...
     */
    public function priceBuy($price){
            $priceBuy = number_format($price + 200);
            return $priceBuy;
    }
    public function priceSell($price){
    ...
    public function buy()
    {
        ...
        if($price){
            ...
            $price = floor($giaCoint * $gia_usd);
            $max = $max_usd * $giaCoint;
            $priceSell = $this->priceSell($price);
            $priceBuy = $this->priceBuy($price);
        }
